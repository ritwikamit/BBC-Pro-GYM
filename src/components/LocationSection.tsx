            ...
            <div className="p-6 sm:p-8 rounded-3xl glass-card backdrop-blur-xl">
              ...
              <div className="space-y-3 font-mono">
                {GYM_DATA.hours.map((item, idx) => (
                  <div key={idx} className="p-3.5 rounded-2xl bg-white/[0.03] border border-white/10 flex flex-col sm:flex-row sm:items-center justify-between gap-1 hover:border-[#ffd000]/30 transition-colors">
                    <div>
          ...
          <div className="lg:col-span-6">
            <div className="rounded-3xl overflow-hidden glass-panel border-white/15 p-2 shadow-2xl backdrop-blur-xl">
              <div className="relative h-[340px] sm:h-[420px] md:h-[480px] lg:h-[520px] w-full rounded-2xl overflow-hidden bg-[#0d0d12]">
                ...
                <div className="absolute bottom-3 sm:bottom-4 left-3 sm:left-4 right-3 sm:right-4 p-3.5 sm:p-4 rounded-2xl glass-panel border-white/20 backdrop-blur-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 shadow-2xl">
                  <div>
                    <h4 className="text-xs font-mono font-bold text-white uppercase tracking-wider">
                      BBC PRO GYM · AURANGABAD
                    </h4>
                    <p className="text-[10.5px] sm:text-[11px] font-mono text-white/60 mt-0.5">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="glass-btn-funky text-[11px] font-mono font-bold uppercase tracking-[0.16em] px-4 py-2 rounded-xl flex items-center justify-center gap-1.5 shadow-lg shrink-0 w-full sm:w-auto"
                  >
                    <span>Open Maps</span>
                    <ExternalLink className="w-3 h-3 text-[#050507]" />
                  </a>
                </div>
              </div>
            </div>
